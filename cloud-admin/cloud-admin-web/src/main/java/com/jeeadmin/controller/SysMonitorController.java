...
import com.jeeadmin.api.IServerInfoService;
...
public class SysMonitorController extends BaseController {
    ...
    public ResultData systemInfo() {
        return this.success(serverInfoService.getSystemInfo());
    }
    ...
    public ResultData diskInfo() {
        return this.success(serverInfoService.getDiskListInfo());
    }
    ...
    public ResultData serverInfo() {
        ...
        map.put("cpu", serverInfoService.getCpuInfo());
        map.put("jvm", serverInfoService.getJvmInfo());
        map.put("mem", serverInfoService.getMemInfo());
    ...
    public ResultData cpuUsedPerc() {
        Map<String, Object> map = new HashMap<>();
        map.put("cpu", serverInfoService.getCpuInfo().get("usedPerc"));
        map.put("mem", serverInfoService.getMemInfo().get("usedPerc"));
